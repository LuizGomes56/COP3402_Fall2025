...
MayFail ts_get_symbol(TokenStream *self, int symbol_index);
...
MayFail ts_get_symbol(TokenStream *self, int symbol_index) {
    return st_get_index(symbol_index);
}
...
MayFail ts_statement(TokenStream *self) {
    ...
    case TokenType_Ident: {
        ...
        MayFail get_symbol_fail_2 = ts_get_symbol(self, symbol_index_s0);
    ...
    case TokenType_Read: {
        ...
        MayFail get_Symbol_fail_3 = ts_get_symbol(self, symbol_index_s1);
...
MayFail ts_factor(TokenStream *self) {
    ...
    case TokenType_Ident: {
        ...
        MayFail symbol_fail = ts_get_symbol(self, symbol_index);
...
int main() {
    ...
    // for (int i = 0; i < len; ++i) {
    //     printf("Token %zu: kind=%d meta=\"%s\"\n", i, tokens[i].kind, tokens[i].meta);
    // }
